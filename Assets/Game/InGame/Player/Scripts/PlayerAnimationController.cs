...
namespace PPack
{
    public class PlayerAnimationController : MonoBehaviour
    {
        ...
        private void EnableLockOn(bool enable)
        {
            ...
            {
                _currentLockOnTarget.GetComponent<PlayerObjectLockOn>().Highlight(true, true);
            }
        }
        ...
        private void UpdateBestTarget()
        {
            ...
            else
            {
                ...
                {
                    target.GetComponent<PlayerObjectLockOn>().Highlight(false, false);
            ...
            if (!_isLockedOn)
            {
                ...
                if (_currentLockOnTarget != null)
                {
                    _currentLockOnTarget.GetComponent<PlayerObjectLockOn>().Highlight(true, false);
                }
            }
            else
            {
