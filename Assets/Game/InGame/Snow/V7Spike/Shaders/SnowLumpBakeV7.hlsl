...
// kernel (SnowPileFieldV7.compute) and the marcher (SnowMarchCoreV7.hlsl), so the thing that writes
...
// the METAL note in SnowCasualStyleV7.hlsl for the real constraint and why the convention is
// stricter than it.
// -----------------------------------------------------------------------------------------------
